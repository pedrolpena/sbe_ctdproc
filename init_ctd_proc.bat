...
echo ^<ServerName value="Bottle Summary" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<InstrumentPath value="Z:\Users\jhooper\Documents\Work_Data\WBTS\ab1403\sbe_ctd\raw_data\AB1403_002.XMLCON" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<InstrumentMatch value="0" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<InputDir value="Z:\Users\jhooper\Documents\Work_Data\WBTS\ab1403\sbe_ctd\1db\proc_data" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<InputFileArray size="1" GrowBy="-1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="0" value="ab1403_002.ros" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</InputFileArray^> >>%PSA_1DB%\BottleSum.psa
echo ^<OutputDir value="Z:\Users\jhooper\Documents\Work_Data\WBTS\ab1403\sbe_ctd\bottle" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<NameAppend value="" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<OutputFile value="ab1403_002.btl" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<LastProcessed value="0" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<OutputMinMaxValues value="0" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<AverageCalcArray Size="15" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="0" CalcID="72" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="-1" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Scan Count" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="1" CalcID="84" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="52" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Time, Elapsed [seconds]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="2" CalcID="17" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="31" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Depth [salt water, m]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<Latitude value="0.000000" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="3" CalcID="65" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="3" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Pressure, Digiquartz [db]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="4" CalcID="81" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="6" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Temperature [ITS-90, deg C]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="5" CalcID="81" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="6" Ordinal="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Temperature, 2 [ITS-90, deg C]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="6" CalcID="12" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="58" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Conductivity [S/m]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="7" CalcID="12" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="58" Ordinal="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Conductivity, 2 [S/m]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="8" CalcID="57" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="63" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Oxygen raw, SBE 43 [V]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyHysteresisCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="9" CalcID="57" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="63" Ordinal="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Oxygen raw, SBE 43, 2 [V]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyHysteresisCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="10" CalcID="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="29" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Altimeter [m]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="11" CalcID="39" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="4" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Latitude [deg]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="12" CalcID="40" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="4" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Longitude [deg]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="13" CalcID="55" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="68" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Oxygen, SBE 43 [dov/dt]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<WindowSize value="2.000000" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyHysteresisCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyTauCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="14" CalcID="55" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="68" Ordinal="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Oxygen, SBE 43, 2 [dov/dt]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<WindowSize value="2.000000" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyHysteresisCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyTauCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^</AverageCalcArray^> >>%PSA_1DB%\BottleSum.psa
echo ^<SelectArray ^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="0" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="1" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="2" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="3" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="4" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="5" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="6" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="7" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="8" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="9" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="10" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="11" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="12" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="13" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ArrayItem index="14" value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</SelectArray^> >>%PSA_1DB%\BottleSum.psa
echo ^<DeriveCalcArray Size="6" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="0" CalcID="62" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="6" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Potential Temperature [ITS-90, deg C]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="1" CalcID="62" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="6" Ordinal="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Potential Temperature, 2 [ITS-90, deg C]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="2" CalcID="70" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="49" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Salinity, Practical [PSU]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="3" CalcID="70" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="49" Ordinal="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Salinity, Practical, 2 [PSU]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="4" CalcID="55" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="40" Ordinal="0" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Oxygen, SBE 43 [ml/l]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<WindowSize value="2.000000" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyHysteresisCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyTauCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
echo ^</CalcArrayItem^> >>%PSA_1DB%\BottleSum.psa
echo ^<CalcArrayItem index="5" CalcID="55" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<Calc UnitID="40" Ordinal="1" ^> >>%PSA_1DB%\BottleSum.psa
echo ^<FullName value="Oxygen, SBE 43, 2 [ml/l]" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<WindowSize value="2.000000" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyHysteresisCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^<ApplyTauCorrection value="1" /^> >>%PSA_1DB%\BottleSum.psa
echo ^</Calc^> >>%PSA_1DB%\BottleSum.psa
