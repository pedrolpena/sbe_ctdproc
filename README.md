...
If you with to use PSA files other than the ones generated by the script,<br>
you could overwrite the PSA files that are created after running init_ctd_proc scripts<br>
